const listMatches = [{
  ...
  },
  {
    ...
    group: 'C',
    match: 3,
    home: { name: 'Saudi Arabia', goals: 1 },
    away: { name: 'Mexico', goals: 2 },
    date: '30 November 2022 22:00',
    stadium: 'lusail'
  },
  {
  ...
  },
  {
    ...
    group: 'E',
    match: 3,
    home: { name: 'Costa Rica', goals: 2 },
    away: { name: 'Germany', goals: 4 },
    date: '1 December 2022 22:00',
    stadium: 'albayt'
  },
  {
  ...
  },
  {
    ...
    group: 'F',
    match: 2,
    home: { name: 'Belgium', goals: 0 },
    away: { name: 'Morocco', goals: 2 },
  ...
  },
  {
    ...
    group: 'G',
    match: 2,
    home: { name: 'Cameroon', goals: 3 },
    away: { name: 'Serbia', goals: 3 },
  ...
  },
  {
    ...
    group: 'G',
    match: 3,
    home: { name: 'Cameroon', goals: 1 },
    away: { name: 'Brazil', goals: 0 },
  ...
  },
  {
    ...
    group: 'G',
    match: 3,
    home: { name: 'Serbia', goals: 2 },
    away: { name: 'Switzerland', goals: 3 },
    date: '2 December 2022 22:00',
    stadium: 's974'
  },
  {
  ...
  },
  {
    ...
    group: 'H',
    match: 2,
    home: { name: 'South Korea', goals: 2 },
    away: { name: 'Ghana', goals: 3 },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1A', name: 'Netherlands', goals: 3, penalties: null },
    winner: null,
    loser: null,
    away: { id: '2B', name: 'United-States', goals: 1, penalties: null },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1C', name: 'Argentina', goals: 2, penalties: null },
    winner: null,
    loser: null,
    away: { id: '2D', name: 'Australia', goals: 1, penalties: null },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1E', name: 'Japan', goals: 1, penalties: 1 },
    winner: null,
    loser: null,
    away: { id: '2F', name: 'Croatia', goals: 1, penalties: 3 },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1G', name: 'Brazil', goals: 4, penalties: null },
    winner: null,
    loser: null,
    away: { id: '2H', name: 'South-Korea', goals: 1, penalties: null },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1B', name: 'England', goals: 3, penalties: null },
    winner: null,
    loser: null,
    away: { id: '2A', name: 'Senegal', goals: 0, penalties: null },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1D', name: 'France', goals: 3, penalties: null },
    winner: null,
    loser: null,
    away: { id: '2C', name: 'Poland', goals: 1, penalties: null },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1F', name: 'Morocco', goals: 0, penalties: 3 },
    winner: null,
    loser: null,
    away: { id: '2E', name: 'Spain', goals: 0, penalties: 0 },
  ...
  },
  {
    ...
    group: 'roundOf16',
    match: 4,
    home: { id: '1H', name: 'Portugal', goals: 6, penalties: null },
    winner: null,
    loser: null,
    away: { id: '2G', name: 'Switzerland', goals: 1, penalties: null },
  ...
  },
  {
    ...
    group: 'quarterFinals',
    match: 5,
    home: { id: 'GP49', name: 'Netherlands', goals: 2, penalties: 3 },
    winner: null,
    loser: null,
    away: { id: 'GP50', name: 'Argentina', goals: 2, penalties: 4 },
  ...
  },
  {
    ...
    group: 'quarterFinals',
    match: 5,
    home: { id: 'GP51', name: 'Croatia', goals: 1, penalties: 4 },
    winner: null,
    loser: null,
    away: { id: 'GP52', name: 'Brazil', goals: 1, penalties: 2 },
  ...
  },
  {
    ...
    group: 'quarterFinals',
    match: 5,
    home: { id: 'GP53', name: 'England', goals: 1, penalties: null },
    winner: null,
    loser: null,
    away: { id: 'GP54', name: 'France', goals: 2, penalties: null },
  ...
  },
  {
    ...
    group: 'quarterFinals',
    match: 5,
    home: { id: 'GP55', name: 'Morocco', goals: 1, penalties: null },
    winner: null,
    loser: null,
    away: { id: 'GP56', name: 'Portugal', goals: 0, penalties: null },
  ...
  },
  {
    ...
    group: 'semifinals',
    match: 6,
    home: { id: 'GP57', name: 'Argentina', goals: 3, penalties: null },
    winner: null,
    loser: null,
    away: { id: 'GP58', name: 'Croatia', goals: 0, penalties: null },
  ...
  },
  {
    ...
    group: 'semifinals',
    match: 6,
    home: { id: 'GP59', name: 'France', goals: 2, penalties: null },
    winner: null,
    loser: null,
    away: { id: 'GP60', name: 'Morocco', goals: 0, penalties: null },
  ...
  },
  {
    ...
    match: 7,
    home: { id: 'PP61', name: 'Croatia', goals: null, penalties: null },
    winner: null,
    loser: null,
    away: { id: 'PP62', name: 'Morocco', goals: null, penalties: null },
  ...
  },
  {
    ...
    group: 'final',
    match: 7,
    home: { id: 'GP61', name: 'Argentina', goals: null, penalties: null },
    winner: null,
    loser: null,
    away: { id: 'GP62', name: 'France', goals: null, penalties: null },
